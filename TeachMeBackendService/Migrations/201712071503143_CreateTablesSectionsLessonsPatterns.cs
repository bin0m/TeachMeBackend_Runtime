namespace TeachMeBackendService.Migrations
{
    ...
    public partial class CreateTablesSectionsLessonsPatterns : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Section2", t => t.Section2Id)
                .ForeignKey("dbo.Sections", t => t.SectionId)
                .ForeignKey("dbo.Section3", t => t.Section3Id)
                .Index(t => t.SectionId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Section2", t => t.Section2Id, cascadeDelete: true)
                .Index(t => t.Section2Id)
                .Index(t => t.CreatedAt, clustered: true);
            ...
            AlterColumn("dbo.Courses", "Days", c => c.Int(nullable: false));
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Lessons", "Section3Id", "dbo.Section3");
            DropForeignKey("dbo.Lessons", "SectionId", "dbo.Sections");
            DropForeignKey("dbo.Section3", "Section2Id", "dbo.Section2");
            DropForeignKey("dbo.Section2", "SectionId", "dbo.Sections");
            DropForeignKey("dbo.Lessons", "Section2Id", "dbo.Section2");
            ...
            DropIndex("dbo.Section3", new[] { "CreatedAt" });
            DropIndex("dbo.Section3", new[] { "Section2Id" });
            DropIndex("dbo.Section2", new[] { "CreatedAt" });
            DropIndex("dbo.Section2", new[] { "SectionId" });
            ...
            AlterColumn("dbo.Courses", "Days", c => c.String());
