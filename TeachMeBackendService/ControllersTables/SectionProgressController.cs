...
{
    [ApiVersion("1.0")]
    [RoutePrefix("api/v{version:ApiVersion}/sectionprogress")]
    [Authorize]
    public class SectionProgressController : TableController<SectionProgress>
    {
        ...
        [Route("{id}", Name = "GetSectionProgress")]
        ...
        public async Task<IHttpActionResult> PostSectionProgress(SectionProgress item)
        {
            ...
            return CreatedAtRoute("GetSectionProgress", new { id = current.Id }, current);
        }
